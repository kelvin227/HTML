...
<html lang="en">
  ...
  <div class="content">
    ...
    <div class="content__actions">
        <a href="edit.php">
            <span fill="currentColor" class="fa fa-pencil-square-o"><div>Update profile</div></span></a></div>
    ...
    <div class="content__button"><a class="button" href="main_feed.php">
        ...
        <p class="button__text">Home</p></a>
        <a class="button" href="tools.php">
        <div class="button__border"></div>
        <div class="button__bg"></div>
        <p class="button__text">Tools</p></a>
        <a class="button" href="tools/integrate.php">
        <div class="button__border"></div>
        <div class="button__bg"></div>
        <p class="button__text">Integrate</p></a>
      </div>
  </div>
